            ...
            <div className="bg-[#F8F4EA]/50 backdrop-blur-sm rounded-2xl border border-[#CFEFF5]/30 p-6 animate-fade-up-delayed">
              ...
              <div className="flex flex-wrap gap-2">
                {authorInfo.roles.map((role, i) => (
                  <span
                    key={i}
                    className="px-3 py-2 bg-white text-[#1E4D8F] text-sm font-montserrat font-medium border border-[#63B8E6]/20 hover:border-[#D4AF37]/50 hover:text-[#D4AF37] hover-lift transition-all rounded-full shadow-sm"
                  >
                    {role}
                  </span>
                ))}
